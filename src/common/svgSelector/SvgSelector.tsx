...
export const SvgSelector = (props: PropsType) => {
    ...
    case 'dialogs':
      return (
        ...
        >
          ...
          <path d="M16.6 18.8c-.2.1-.4.2-.6.2s-.4-.1-.6-.2L2 9.9V23c0 2.8 2.2 5 5 5h18c2.8 0 5-2.2 5-5V9.9l-13.4 8.9z" />
        </svg>
      )
    case 'news':
      return (
    ...
    case 'password':
      return (
        <svg
          ...
          {...props}
        >
          <path d="M64 1C47.5 1 34 14.5 34 31v26H15v70h99V57H94V31C94 14.5 80.5 1 64 1zM42 31c0-12.1 9.9-22 22-22s22 9.9 22 22v26H42V31zm64 34v54H23V65h83z" />
    ...
    case 'likes':
      return (
        <svg
          ...
          {...props}
        >
          <path d="M20.938 10.725C14.51.796 1.5 6.205 1.5 17.021c0 8.122 17.836 20.827 19.438 22.479C22.551 37.848 39.5 25.143 39.5 17.021c0-10.734-12.122-16.225-18.562-6.296z" />
        </svg>
      )
    case 'delete':
      return (
    ...
    case 'logout':
      return (
        <svg
          ...
          {...props}
        >
          <path d="M25.229 14.5H9.226a1.5 1.5 0 0 0 0 3h16.038l-3.114 3.114a1.501 1.501 0 0 0 2.122 2.121l4.242-4.242a3.5 3.5 0 0 0 0-4.95L24.272 9.3a1.502 1.502 0 0 0-2.122 0 1.502 1.502 0 0 0 0 2.122l3.079 3.078Z" />
          <path d="M20 24v-4.5H9.226a3.501 3.501 0 0 1-3.5-3.5c0-1.932 1.568-3.5 3.5-3.5H20V8a5 5 0 0 0-5-5H8a5.004 5.004 0 0 0-3.536 1.464A5.004 5.004 0 0 0 3 8v16c0 1.326.527 2.598 1.464 3.536A5.004 5.004 0 0 0 8 29h7a5.004 5.004 0 0 0 3.536-1.464A5.004 5.004 0 0 0 20 24Z" />
        </svg>
      )
    case 'profileLight':
      return (
